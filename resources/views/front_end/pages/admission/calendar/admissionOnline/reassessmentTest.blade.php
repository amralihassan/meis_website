...
@section('content')
    <section class="hero-wrap hero-wrap-2" style="background-image: url({{ url('public/design/site/images/bg_2.jpg') }});">
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            ...
            <h1 class="mb-2 bread">Assessment test calendar</h1>
    ...
    <section class="ftco-section contact-section">
        <div class="container">
            <div class="alert alert-info">
                ...
                <input type="hidden" name="module" value="reassessmentTest">
                <input type="hidden" name="applicationCode" value="{{request()->segment(3)}}">
                    <div class="form-group">
                        <h6><b>{{trans('admission::admission.setReassessmentDate')}}</b></h6>

                        <div class="col-sm-3">
                            <p><i>Example : 09/20/2020, 11:30 AM</i></p>
                            <input type="datetime-local" name="start_date" value="" id="startDate">
                        </div>
                    </div>
    ...
    $(document).ready(function(){
        ...
        $(function()
        {
            $('#calendar').fullCalendar({
                ...
                "eventLimit":true,
                "events": "{{route('assessmentTest.all')}}",
            });
        }());
