    ...
    <section class="ftco-section contact-section">
        <div class="container">
            <div class="form-group">
                <h3 style="font-weight: bold">Step 2: Virtual meeting with a public relation</h3>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    <p>A virtual meeting with a public relation representative in order to know more about the school details.</p>
...
@section('javascript')
    ...
    <script>
        function goto()
        {
            window.location.href='{{url("admission/register")}}';
        }
    </script>
@endsection
