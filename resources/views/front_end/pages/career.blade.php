            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-4 d-flex">
                    <div class="bg-light align-self-stretch box p-4 text-center">
                        ...
                        <p style=text-align:left;><b>{{ trans('staff::employee.jobType') }}</b> : {{$vacancy->jobType == 'Full'?trans('staff::employee.fullTime'):trans('staff::employee.partTime')}}</p>
                        <p style=text-align:left;><b>{{ trans('staff::employee.noVacancy') }}</b> : {{$vacancy->noVacancy}}</p>
                        <p style=text-align:left;><b>{{ trans('staff::employee.noExperience') }}</b> : {{$vacancy->noExperience}}</p>
