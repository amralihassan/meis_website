            ...
            <table id="dynamic-table" class="table display data-table" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th>{{trans('admission::admission.parentInterviewDate')}}</th>
                        <th>{{trans('admission::admission.parentInterview')}}</th>
                    </tr>
                </thead>
    ...
    $(document).ready(function(){
        $(function () {
            ...
            var myTable = $('.data-table').DataTable({
                ...
                serverSide: false,
                pageLength: 25,
                ajax: "{{ route('online.parentInterview') }}",
                dom: 'Bfrtip',
                buttons: [
                        {
                            "extend": "colvis",
                ...
                columns: [
                    ...
                    {data: 'parentsInterviewDate', 	name: 'parentsInterviewDate'},
                    {data: 'parentInterview', 	    name: 'parentInterview'},
    ...
    function filter()
    {
      ...
      var myTable = $('#dynamic-table').DataTable({
                    ...
                    columns: [
                          ...
                          {data: 'grade', 	              name: 'grade'},
                          {data: 'academicYear', 		  name: 'academicYear'},
                          {data: 'parentInterviewDate',   name: 'parentInterviewDate'},
                          {data: 'parentInterview', 	  name: 'parentInterview'},
                    ],
                    @include('layouts.datatable.language')
                });
