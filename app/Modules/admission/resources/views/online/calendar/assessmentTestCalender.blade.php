            ...
            <table id="dynamic-table" class="table display data-table" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th>{{trans('admission::admission.assessmentTestDate')}}</th>
...
<script>
    $(document).ready(function(){
        $(function () {
            ...
            var myTable = $('.data-table').DataTable({
                ...
                serverSide: false,
                pageLength: 25,
                ajax: "{{ route('online.openAssessment') }}",
                dom: 'Bfrtip',
                buttons: [
                        {
                            "extend": "colvis",
                ...
                columns: [
                    ...
                    {data: 'assessmentTestDate',    name: 'assessmentTestDate'},
                    {data: 'openAssessment', 	    name: 'openAssessment'},
    ...
    function filter()
    {
      ...
      var myTable = $('#dynamic-table').DataTable({
                    ...
                    ajax:{
                        type:'POST',
                        url:'{{route("openAssessment.filter")}}',
                        data: {
                            _method  : 'PUT',
                            fromDate : fromDate,
                            toDate   : toDate,
